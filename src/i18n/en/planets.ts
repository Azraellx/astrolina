...
export const planets = {
  ...
  NorthNode: { name: 'N Node', theme: 'Your soul’s growth path and where you’re headed this life.' },
  SouthNode: { name: 'S Node', theme: 'Familiar past-life gifts and patterns to grow beyond.' },
  ...
  Ceres: { name: 'Ceres', theme: 'Nurturing, nourishment, and how you give and receive care.' },
